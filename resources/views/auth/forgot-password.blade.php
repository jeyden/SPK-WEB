...
<head>
    ...
    <title>Lupa Password - Sistem Pendukung Keputusan Pemilihan Jurusan</title>
        ...
        <div class="glass border border-white/10 rounded-3xl shadow-2xl shadow-indigo-950/40 overflow-hidden">
            <div class="p-6 sm:p-8">
                ...
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-2xl font-bold text-white tracking-tight mt-1">Lupa Password?</h2>
                    <p class="text-xs text-slate-400 mt-1">Masukkan email terdaftar Anda, kami akan mengirimkan tautan reset password</p>
                </div>

                <!-- Notifikasi Sukses -->
                @if (session('success'))
                    <div class="mb-4 p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-200 text-xs flex items-center gap-2">
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="email" placeholder="nama@sekolah.sch.id"
                ...
                <p class="text-center text-xs text-slate-400">
                    ...
                    <a href="{{ route('login') }}" class="text-indigo-400 hover:text-indigo-300 font-semibold ml-1 transition">
